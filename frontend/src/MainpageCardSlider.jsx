...
const MainpageCardSlider = () => {
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <div class="card ">
        <img src="https://cdn.liveaplus.com/uploads/2014/08/TheShawshankRedemption.1-300x226.jpg" alt="Slide" class="card-img-top "/>
        <div class="card-body">
      ...
      <div class="card d-none d-md-block">
        <img src="https://m.media-amazon.com/images/M/MV5BOWE1MWE3ZDktOThlZS00ZmRiLWE4ZGEtNWJkMTVlZjdhZDIyXkEyXkFqcGdeQW1pYnJ5YW50._V1_.jpg" alt="Slide" class="card-img-top"/>
        <div class="card-body">
          <h5 class="card-title">Card title</h5>
          <a href="#" class="btn btn-primary">Go somewhere</a>
        </div>
      ...
      <div class="card d-none d-md-block">
        <img src="https://m.media-amazon.com/images/I/51r4i5VQK3L._AC_SY1000_.jpg" alt="Slide" class="card-img-top"/>
        <div class="card-body">
          <h5 class="card-title">Card title</h5>
          <a href="#" class="btn btn-primary">Go somewhere</a>
        </div>
